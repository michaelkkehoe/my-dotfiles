# my-dotfiles (Michael Kehoe)
My dotfiles for Linux and OSX (bash & zsh)
...
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/michaelkkehoe/my-dotfiles/master/bin/install)"
```
